from vision_transformers.yolact_edge.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone, MobileNetV2Backbone
...
custom_dataset = dataset_base.copy({
  ...
  'class_names': ('Motorcycle', 'Obstacle'),
  'label_map': { 0: 1, 1: 2},
...
yolact_edge_mobilenetv2_custom_config = yolact_edge_mobilenetv2_config.copy({
    ...
    'torch2trt_max_calibration_images': 5,
})

yolact_edge_mobilenetv2_custom_config_slope_champion_3_zoom_5 = yolact_edge_mobilenetv2_custom_config.copy({
    'augment': [A.Affine(translate_percent = (-0.05, 0.05), shear = (-8, 8), rotate = (-8, 8), scale = (0.8, 1.2), p=0.5), \
        A.RandomBrightnessContrast(brightness_limit=0.8, contrast_limit = 0.8, p=0.5)],
    'lr_schedule': 'cosine'
    })


yolact_edge_mobilenetv2_custom_config_park_champion_3_zoom_5 = yolact_edge_mobilenetv2_custom_config.copy({
    'augment': [A.Affine(translate_percent = (-0.05, 0.05), shear = (-8, 8), rotate = (-8, 8), scale = (0.8, 1.2), p=0.5), \
        A.RandomBrightnessContrast(brightness_limit=0.8, contrast_limit = 0.8, p=0.5)],
    })
